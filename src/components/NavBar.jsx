...
<div data-tauri-drag-region class="h-5 w-full">
  <div class="flex flex-row justify-end items-end w-full h-full bg-black bg-opacity-70">
        <div class="h-6 pl-4 pt-0.5">
          <p class="text-xs font-sans font-thin text-stone-400">CRIM v0.1 indev</p>
        </div>
        <div class="ml-auto bg-transparent flex flex-row gap-x-2 items-start justify-start">
          <button
